...
function v() {
    var e = d(), t = e.screenHeight, n = void 0 === t ? 0 : t, r = e.screenWidth;
    return {
...
function M(e, t) {
    void 0 === t && (t = {});
    try {
        var n = Tn.platform.information, r = (n && n.getUserInfo() || {}).uniqueId, i = (D() || {}).gameId;
...
function q() {
    var e = D(), t = e.videoCoolTime, n = e.videoTimeout;
...
function F() {
    var e = D().gameId, t = tn.combHost + "/comb-ad-server/api/v1/combAd?gameId=" + e + "&gameTp=minigame&adTp=miniGameWxAdId";
    ...
    return t(this, void 0, void 0, function() {
        ...
        return n(this, function(n) {
            switch (n.label) {
              ...
              case 1:
                return t = n.sent(), fe(3), Zt.dispatch(Vt, t), function() {
                    if (!Ro) {
                        Ro = !0;
                        var e = (D() || {}).gameId, t = (Mr.getTempUser() || {}).uniqueId;
...
function J(e) {
    var t = D().getUserInfoBtn, n = function(e) {
        return wo ? wx.createUserInfoButton(Object.assign({}, {
            lang: "zh_CN"
        }, e)) : null;
    }(e || t);
    return n && n.onTap(function(e) {
        var t = e || {}, n = t.userInfo, r = t.encryptedData, i = n || {}, o = i.nickName, s = i.gender;
        o && Zt.dispatch(mr, {
            nickName: o,
            gender: s
            ...
            switch (n.label) {
              ...
              case 1:
                ...
                we({
                    ...
                    var r = D(), i = r.gameId, o = r.gameVersion, a = r.cryptRule, c = Math.floor(new Date().getTime() / 1e3), u = e.combSdkInfo, d = e.combUser, f = e.envCombSdkInfo, h = U(), g = h.custom, p = h.query, m = h.scene, v = h.referrerInfo, y = "", I = "";
                    v && v.extraData && (y = v.extraData.origGameId || "", I = v.extraData.origUniqueId || "");
                    var _ = g || {}, S = _.channel, T = _.origChannel, b = _.pageQuery, C = _.shareConfigId, x = _.activityId, k = _.h_shareCode, O = _.boxCode, P = "";
                    try {
                        P = JSON.stringify(h);
                    } catch (e) {
                        e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                    ...
                    var E = "" + tn.combHost + on + "?gameId=" + i + "&gameTp=minigame&system=" + (w() ? "ios" : "android") + "&version=" + o + "&deviceUniqueId=" + Un.deviceId + "&loginTag=code&cryptVersion=1.1.0", A = {
                        gameId: i,
                        gameTp: nn,
                        timestamp: c,
                        loginInfo: {
                    ...
                    a.codeBookLen;
                    var N = a.swapTimes, L = a.keySkip, R = a.keyOffset, q = So.encode(No(JSON.stringify(A)), M, N, L, R), H = No(q);
...
function te(e, r, o, a) {
    return t(this, void 0, void 0, function() {
        var t, c, u, d, f, h, g, p, m, v, y, I, _, S, T, b, C, x, k, O, P, E, A, N, L, R, q, H, F, j, V, G, W;
        return n(this, function(n) {
            switch (n.label) {
              case 0:
                t = a.codeBook, a.codeBookLen, c = a.swapTimes, u = a.keySkip, d = a.keyOffset, 
                f = D(), h = f.gameId, g = f.gameVersion, p = U(), m = p.custom, v = p.query, y = p.scene, 
                I = p.referrerInfo, _ = "", S = "", I && I.extraData && (_ = I.extraData.origGameId || "", 
                S = I.extraData.origUniqueId || ""), b = (T = m || {}).channel, C = T.origChannel, 
                x = T.pageQuery, k = T.shareConfigId, O = T.activityId, P = T.h_shareCode, E = T.boxCode, 
                A = "";
                try {
                    A = JSON.stringify(p);
                } catch (e) {
              ...
              case 1:
                return n.trys.push([ 1, 3, , 4 ]), L = "" + tn.combHost + rn + "?gameId=" + h + "&gameTp=minigame&system=" + (w() ? "ios" : "android") + "&version=" + g + "&deviceUniqueId=" + Un.deviceId + "&loginTag=code&cryptVersion=1.1.0", 
                i("login code params", N), R = So.encode(No(JSON.stringify(N)), t, c, u, d), q = No(R), 
                An.platformLogin = Date.now(), [ 4, bn.postText(L, q) ];

              case 2:
                return H = n.sent().data, F = H.combUser, j = F.encryptCombUser, V = F.timestamp, 
                G = F.sign, H.encryptUserInfo = {
                    userInfo: j,
                    timestamp: V,
                    sign: G
                }, H.userSdk = H.combSdkInfo, H.envCombSdkInfo ? H.userSdk.userId = H.envCombSdkInfo.userId : H.userSdk.userId = H.combSdkInfo.userId, 
                H.envCombSdkInfo && (H.userSdk.isAuth = H.envCombSdkInfo.isAuth), i("entry login", H), 
                (!1 === H.userSdk.isAuth || o) && (H.encryptUserInfo = null, H.combUser = null), 
                se(H), Mr.setTempUser(H), [ 2, H ];

              case 3:
                throw s("entry err", W = n.sent()), Mr.clearUserInfo(), M(HSDK.MonitorType.PlatformLoginFail, W), 
                yn.pkgError(W, Lt);
...
function se(e) {
    var t = e || {}, n = t.encryptUserInfo, r = t.userSdk, i = t.combSdkInfo.uniqueId, o = D().gameId;
    n && (function() {
        if (!Mr.getUserInfo(!0)) {
            var e = U() || {}, t = e.custom || {}, n = t.shareConfigId, r = t.activityId;
            fe(1, {
...
function fe(e, t) {
    var n = Mr.getTempUser() || {}, r = n.userId, i = n.uniqueId, o = U(), a = "";
    try {
        a = JSON.stringify(o);
    } catch (e) {
        e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
    ...
    var u = o.custom, d = o.scene, l = u || {}, f = o.coldStart ? 0 : 1, h = {
        logType: e,
        channel: l.channel,
...
function pe() {
    ...
    var e = D(), t = e.autoUploadSDTLog, n = e.stdAutoUpload, r = e.tgaAutoUpload, i = e.stdHeartBeatInterval;
    if (!1 !== r || n || t) {
        if (me(po.INIT, {
            eventType: "track",
            eventName: "sdk_init"
...
function me(e, t, n) {
    var r = uo, i = lo, o = D(), s = o.autoUploadSDTLog, a = o.stdAutoUpload, c = o.tgaAutoUpload, u = e.logType;
    a || s || (u = (u | i) === u ? u ^ i : u), !1 === c && (u = (u | r) === u ? u ^ r : u), 
    u && (e.logType = u, ve(e, t, n));
}

function ve(e, t, n) {
    var r = new ge(e, t, n), i = r.getConfig(), o = i.stopWhenShare, s = i.callAfterLogin;
    Bo.getState(Pr) && o || (s ? function(e) {
        if (yn.isFun(e)) {
            var t = Mr.getSDKUserInfo() || {}, n = t.uniqueId;
...
function we(e) {
    var t = e.eventName, n = void 0 === t ? "" : t, r = e.data, i = void 0 === r ? {} : r, o = e.eventType, s = void 0 === o ? "track" : o;
...
function Ie(e) {
    var t = e.state, n = e.type, r = void 0 === n ? "" : n, i = e.errMsg, o = void 0 === i ? "" : i, s = e.id;
    we({
        eventName: "sdk_ad",
        data: {
            ad_state: t,
...
function xe(e) {
    var t = e.node, n = e.url, r = e.x, i = e.y, o = e.width, s = e.height, a = e.type;
...
function Pe(e) {
    ...
    var l = new cc.Node("subTitleTextNode"), f = l.addComponent(cc.Label);
    f.string = "请使用微信扫一扫完成支付", f.fontSize = 32, f.fontFamily = "Impact", a.addChild(l), 
    l.y = -250, l.color = new cc.Color().fromHEX("#000000cc"), Ee({
        node: function(e) {
            var t = e.node, n = e.x, r = e.y, i = e.width, o = e.height, s = e.callBack, a = new cc.Node();
...
function Ee(e) {
    var t = e.node, n = e.url, r = e.x, i = e.y, o = e.width, s = e.height;
            ...
            return n(this, function(n) {
                ...
                f = e.cancelButton, h = e.hideOpenCustomerServiceParam, [ 2, new Promise(function(e, n) {
                    ...
                    "function" == typeof c ? c(function(t) {
                        ...
                        success: function(t) {
                            if (t.confirm) g(e, n, null); else if (t.cancel) {
                                var r = "modal cancel";
                                Be({
                                    state: "sdkfail",
                                    errMsg: r
    ...
    if (0 === (null === (t = null == e ? void 0 : e.meta) || void 0 === t ? void 0 : t.errCode) && (null == e ? void 0 : e.data)) {
        ...
        Object.keys(e.data).forEach(function(t) {
            e.data[t].forEach(function(e) {
                var r = e.shareDescription, i = e.id, o = e.shareImgUrl, s = e.previewId, a = e.previewUrl, c = e.shareSceneType, u = e.shareSuccessDiff, d = e.thumbnailId, l = e.thumbnailUrl, f = e.shareTitle, h = e.msgTp;
                n.push({
                    type: t,
                    category: "",
                    desc: r,
...
function et(e, t, n, r, i) {
    Bo.setState(Pr, !1);
    var o = r ? Math.max(yn.getTime() - r, 0) : 0, s = Et(Et({
        shareData: t,
        shareSuccess: n,
        spentTime: o
    }, e), {
...
function tt(e) {
    var t = (ys || {}).shareData, n = (e || {}).shareType, r = n ? ws[n] : null, i = r ? r.getData() : t || {};
...
function nt(e, t, n, r) {
    ...
    var c = ys || {}, u = c.shareSuccessDiff, d = c.onShareCallbackTime, l = o || {}, f = l.shareSuccessDiff, h = l.onShareCallbackTime, g = l.activityId, p = Object.assign({}, o, {
        shareSuccessDiff: f || u,
        onShareCallbackTime: h || d
    }), m = t || {}, v = m.success, y = m.fail, w = m.complete, I = hs.renderPostParams(p), _ = new Xe(), S = {
        complete: function(e) {
...
function ot(e) {
    !function(e) {
        ...
        var n = e && yn.isFun(e) ? e(t) : null, r = n || {};
        return nt(n, {
            success: r.success,
            fail: r.fail,
            complete: r.complete
...
function at() {
    ...
    if (D().usePrivateShare) {
        var e = D().gameId, r = Mr.getSDKUserInfo() || {}, o = r.uniqueId, s = r.userId;
        bn.post(tn.combHost + "/comb-login-server/api/v1/user/activityId", {
            gameId: e,
            uniqueId: o,
            openId: s
        }).then(function(e) {
            var r = e.data, i = r.activityId, o = r.activityKey;
            Ss = o, function(e) {
    ...
    return t(this, void 0, void 0, function() {
        return n(this, function(e) {
            return [ 2, new Promise(function(e, t) {
                var n, r = U(), i = r.shareTicket, o = r.query;
                n = {
                    shareTicket: i,
                    success: function(t) {
                        return e(Et(Et({}, t), {
...
function gt(e, t) {
    if (void 0 === t && (t = 0), !(t > 3)) {
        var n = D().gameId, r = e || {}, o = r.acceptIds, s = void 0 === o ? [] : o, a = r.playerId;
        if (s.length) {
            var c = Mr.getSDKUserInfo() || {}, u = c.userId, d = c.uniqueId, l = {
                gameId: n,
...
function It(e) {
    return new Promise(function(t, n) {
        var r = (Mr.getSDKUserInfo() || {}).uniqueId, i = tn.gsHost + "/community-server/api/v1/game/account/background/config?gameId=" + Un.option.combGameId + "&level=" + (e || 1) + "&uniqueId=" + r;
...
function kt(e) {
    var t = (Mr.getSDKUserInfo() || {}).uniqueId, n = D().gameId, r = U().query;
...
var Pt = function(e, t) {
    ...
    return "[HSDK] " + e;
}, Ut = "1.9.0", Dt = "weixin", Mt = "object" == Ot(window.tt) && "object" == Ot(window.wx) && window.tt === window.wx ? (s("当前为头条环境, 但是使用的是微信sdk, 请使用头条sdk"), 
"tt") : "object" == Ot(window.wx) ? "wx" : "debug", Nt = {
    errCode: 500,
    errMsg: "未知错误"
}, Lt = {
    errCode: 1e3,
    errMsg: "网络错误"
}, Rt = "EVT_SDK_READY", qt = "EVT_ON_SHOW", Ht = "EVT_ON_HIDE", Ft = "EVT_ON_ERROR", jt = "EVT_LOGIN_START", Vt = "EVT_ON_LOGIN", Gt = "EVT_UPDATE_START", Wt = "EVT_ON_UPDATE", Kt = "EVT_REPORT_LOG", Bt = "EVT_SET_GAMEUSER", zt = "Test", Jt = "Prod", Qt = "Dev", Xt = "PROC_PRE_AGGR", Yt = "PROC_REQ_AGGR", $t = {}, Zt = {
    ...
    _dispatch: function(e, t) {
        var n = $t[e];
        if (n && !(n.length <= 0)) for (var r = new a(t), i = 0; i < n.length; i++) {
            var o = n[i];
            try {
                o.listener(r);
            } catch (t) {
...
}, nn = "minigame", rn = "/comb-login-server/api/v1/login", on = "/comb-login-server/api/v1/login/check", sn = "/comb-share/server/v1/scheme", an = "/comb-pay-server/api/v1/order/pay/mini/action/login", cn = {
    isFun: function(e) {
...
var un, dn, ln, fn, hn, gn, pn = {
    ...
    _compareVersion: function(e, t) {
        for (var n = e.split("."), r = t.split("."), i = Math.max(n.length, r.length), o = 0; o < i; o++) {
            var s = parseInt(n[o], 10) || 0, a = parseInt(r[o], 10) || 0;
            if (s > a) return 1;
            if (s < a) return -1;
        }
        return 0;
...
}), vn), wn = null === (ln = null === (dn = null === (un = d()) || void 0 === un ? void 0 : un.system) || void 0 === dn ? void 0 : dn.toLowerCase()) || void 0 === ln ? void 0 : ln.startsWith("ios"), In = Object.freeze({
    __proto__: null,
    canUse: u,
    getSystemInfo: d,
    isAppleOS: wn,
...
var On, Pn, En, An = {
    ...
    _comb2Sub: function() {
        var e = this, t = this.sdkConfig(), n = t.gameId, r = t.gameVersion, i = tn.combHost + "/comb-login-server/api/v1/login/crypt/mix?combGameId=" + n + "&gameTp=minigame&system=" + (w() ? "ios" : "android") + "&version=" + r + "&deviceUniqueId=" + this.deviceId;
        return new Promise(function(t, n) {
            bn.get(i).then(function(r) {
                var i;
                if (0 === (null === (i = null == r ? void 0 : r.meta) || void 0 === i ? void 0 : i.errCode) && (null == r ? void 0 : r.data)) {
                    var o = r.data, s = o.subGameId, a = o.cryptRule;
    ...
    var e = Un.sdkConfig() && Un.sdkConfig().env || Jt, t = Mn.HOST_SERVER;
    return (void 0 === t ? {} : t)[e];
}, Ln = function() {
    var e = Un.sdkConfig() && Un.sdkConfig().env || Jt, t = Mn.HOST_LOG;
    return (void 0 === t ? {} : t)[e];
}, Rn = {
    weixin: "/mini/api/v1/log/multi",
    toutiao: "/wxlog/api/v1/log/douyin/multi"
}[Dt], qn = Kt, Hn = Zt, Fn = Tn, jn = i, Vn = bn, Gn = {
    _logs: [],
    _delayer: void 0,
    post: function(e, t) {
    ...
    _report: function() {
        var e = this._logs;
        this._logs = [];
        var t = Fn.platform.information, n = t.getUserInfo() || {}, r = n.userId, i = n.uniqueId, o = t.getConfig(), s = o.gameId, a = o.gameVersion, c = t.getSystemStr(), u = t.getLaunchOpts().query;
    ...
    _delayReport: function() {
        var e = this;
        if (!this._delayer) {
            var t = (Fn.platform.information.getConfig() || {}).logReportFrequency, n = void 0 === t ? 5e3 : t;
...
var Wn = {
...
}, fr = "EVT_SESSION", hr = "EVT_WX_LOGIN", gr = "EVT_TRACK_LOGIN", pr = "EVT_NEED_AUTH", mr = "EVT_ON_AUTH", vr = "EVT_AUTH_DENY", yr = "EVY_PAY_FAIL", wr = "EVT_SHARE_START", Ir = "EVT_SHARE_END", _r = "EVT_SHARE_TIME_START", Sr = "EVT_SHARE_TIME_END", Tr = "EVT_SHARE_FRIEND", br = "EVT_VIDEO_AD_PLAY_START", Cr = "EVT_VIDEO_AD_PLAY_FINISH", xr = "EVT_VIDEO_AD_ERROR", kr = "EVT_INTERSTITIAL_AD_SHOW", Or = "EVT_HORTOR_AD_PLAY_SUCCESS", Pr = "sharing", Er = function() {
    var e = D();
    ...
    getUserInfo: function(e) {
        var t = Ar() || {}, n = t.userInfo, r = t.saveTime;
        if (!n || !r) return null;
        var i = ((n || {}).userSdk || {}).hasUserInfo;
        if (!e && !i) return null;
        var o = D().expireTime || 86400, s = yn.getTimeSec();
    ...
    _logOnShow: function(e) {
        ...
        var t = e.scene, n = e.coldStart, r = Mr.getTempUser() || {}, i = r.userId, o = r.uniqueId, s = U().custom || {}, a = s.channel, c = s.origChannel, u = s.shareConfigId, d = n ? 0 : 1, l = "";
        try {
            e = Object.assign(e, {
                at: "onShow"
            }), l = JSON.stringify(e);
...
var ni = {
    ...
    _processAggr: function(e) {
        ...
        var t = (Tn.platform.information.getUserInfo() || {}).uniqueId, n = Object.assign({}, e.ipregion);
...
var si = {
    ...
    postLog: function(e, t, n) {
        ...
        var r = n || {}, o = r.msg, s = r.errMsg, a = r.message, c = r.logTp, u = t || o || a || s;
        i(e + ": " + u, n);
        var d = Tn.platform.information, l = d.getUserInfo() || {}, f = l.userId, h = l.uniqueId, g = d.getConfig(), p = g.gameId, m = g.gameVersion, v = d.getSystemStr(), y = Object.assign({
            msg: u,
            logTp: c,
            gameId: p,
            gameVersion: m,
            ...
            hortorMsg: u,
            hortorLogTp: e
        }, n || {}), w = tn.logHost + "/wxlog/api/v1/log";
...
var li = {
    ...
    _getRequestData: function(e, t) {
        var n = (t || {}).nickName, r = Tn.platform.information, i = r && r.getUserInfo() || {}, o = i.userId, s = i.uniqueId, a = i.channel, c = r && r.getLaunchOpts() || {}, u = c.scene, d = Un.sdkConfig();
        return {
            gameId: d.gameId,
            nickName: n,
            gameTp: "minigame",
...
var fi = u("createBannerAd", "2.0.4"), hi = u("createRewardedVideoAd", "2.0.4"), gi = u("createRewardedVideoAd", "2.8.0"), pi = u("createInterstitialAd", "2.6.0");
...
R.prototype = {
    ...
    _stdInterstitialAdLog: function(e, t) {
        ...
        var n = this.options, r = n.adUnitId, o = n.sequenceInfo;
        Zt.dispatch(kr, {
            adUnitId: r,
            isEnded: e,
            playFailCode: t,
    ...
    _postLog: function(e) {
        var t = U(), n = t.scene, r = (t.custom || {}).channel;
        Zt.dispatch(Kt, {
            log: {
...
var wi = {}, Ii = {
    ...
    getInterstitialAd: function(e) {
        ...
        var t = e.adUnitId, n = (wi[t] || this.createAdManager(e)).adInstance;
        if (!n) throw ir;
        return n;
    },
    _destroy: function(e) {
...
}, _i = "hortor视频广告", Si = "", Ti = function(e, t, n) {
    void 0 === n && (n = ""), Si = n || Si;
    var r = U(), i = r.scene, o = {
        adUnitId: e,
        logType: t,
...
q.prototype = {
    ...
    _getConnomHorotrAdParams: function(e) {
        var t = Tn.platform.information, n = t.getUserInfo() || {}, r = n.gameId, i = n.uniqueId, o = n.openId, s = t.getSystemInfo();
        return {
...
var Ei = "__APM_TEMP_LOGS", Ai = function() {
    function e(e, t) {
    ...
    return e.prototype.setStorage = function(e) {
        ...
        var n = t || {}, r = n.logs, i = n.sockets, o = n.times, s = e || {}, a = s.logs, c = s.sockets, u = s.times, d = {};
        d.logs = this.limitLens((a || []).concat(r || []), this._max), d.sockets = this.mergeNum(i, c);
        var l = o || u;
        if (l) for (var f in d.times = {}, l) d.times[f] = this.mergeNum((o || {})[f], (u || {})[f]);
        return d;
...
}(), Di = [ "comb-platform", "comb-platform-test", "comb-platform-dev" ], Mi = "requestTimes", Ni = "downloadTimes", Li = function() {
    function e(e) {
...
}(), ji = 1, Vi = [ "comb-platform", "comb-platform-test", "comb-platform-dev" ], Gi = "unc-err", Wi = "soc-err", Ki = function() {
    function e(e, t) {
    ...
    return e(n, t), n.prototype.handle = function() {
        ...
        return function(n) {
            ...
            return e(Object.assign({}, n, {
                success: function(e) {
                    void 0 === e && (e = {});
                    var o, s = e.statusCode, a = e.header ? e.header["Content-Length"] : 0;
                    200 == s ? (o = {
                        status: s,
                        size: a
    ...
    return e(n, t), n.prototype.handle = function() {
        ...
        return function(n) {
            ...
            return e(Object.assign({}, n, {
                success: function(e) {
                    void 0 === e && (e = {});
                    var o, s = e.header ? e.header["Content-Length"] : 0, a = e.statusCode;
                    200 == a ? (o = {
                        status: a,
                        size: s
...
var Zi = function(t) {
    ...
    return e(n, t), n.prototype.handle = function() {
        ...
        var t = e.split("\n"), n = t.slice(0, 2).join("\n"), r = t.slice(2), i = (r[1] || "").split(":"), o = (i.pop() || "").replace(")", "") - 0, s = (i.pop() || "") - 0;
        return {
            line: s = isNaN(s) ? 0 : s,
            column: o,
            msg: n,
...
var io = ro, oo = "sdk_share", so = "sdk_video_ad_show", ao = "track", co = "user_set", uo = 2, lo = 4, fo = {
    INIT: {
        topic: "",
        eventType: ao,
        eventName: "sdk_init",
...
var vo = {
    ...
    _getBaseData: function() {
        var e = D(), t = e.gameId, n = e.gameVersion, r = d();
        return {
            gameId: t,
            gameVersion: n,
            logSource: "mini-sdk",
        ...
        return t(this, void 0, void 0, function() {
            ...
            return n(this, function(n) {
                switch (n.label) {
                  case 0:
                    return e = function() {
                        var e = D(), t = e.gameId + "_" + e.env + "_tgaDistinctId", n = Bn.getStorage(t);
    ...
    _getBasicData: function(e) {
        ...
        if ("track" === r.eventType) {
            var o = d(), s = D(), a = U() || {}, c = a.scene, u = a.query, l = void 0 === u ? {} : u, f = (o.platform || "").toLowerCase(), h = (go || "WIFI").toUpperCase(), g = Mr.getSDKUserInfo() || {}, p = g.channel;
            i = Object.assign({
                "#scene": c || 0,
                "#os": {
                    android: "Android",
    ...
    _getShareEndData: function(e) {
        var t = e || {}, n = t.shareData, r = t.shareSuccess, i = t.spentTime, o = t.extend, s = t.wx_share_type, a = n || {}, c = a.title, u = a.imageUrl, d = a.shareType, l = a.shareConfigId, f = a.shareGuid, h = (a.sequenceInfo || {}).modelId;
        return this._pkg({
            share_guid: f || "",
            share_content_id: l || "",
    ...
    _getVideoAdEndData: function(e) {
        var t = e || {}, n = t.adUnitId, r = t.isEnded, i = t.playFailCode, o = t.spentTime, s = t.sequenceInfo, a = t.extend, c = t.adType, u = s || {}, d = u.modelId, l = u.shareGuid, f = void 0 === r ? -1 : r ? 0 : 1, h = i ? 1004 === i || 1002 === i ? 2 : 1 : 0 === i ? 0 : 1;
        return this._pkg({
            ad_id: n || "",
            event_state: h,
            ad_close_type: f,
    ...
    _getGameUserData: function(e) {
        var t = (U() || {}).query, n = "toNumber", r = "toNStr", i = {
            roleId: r,
            roleName: r,
            serverId: r,
            level: n,
    ...
    _getAuthData: function(e) {
        var t = Mr.getSDKUserInfo() || {}, n = t.name, r = t.sex, i = ((U() || {}).query || {}).share_guid, o = e || {}, s = o.gender, a = void 0 === s ? r : s, c = o.nickName, u = void 0 === c ? n : c, d = o.extend;
        return this._pkg({
            gender: a || 0,
            nick: u || "",
            share_guid: i || ""
    ...
    _getOpenData: function(e) {
        var t = Mr.getSDKUserInfo() || {}, n = t.isNewUser, r = t.createdAt;
        n && (i("change local isNewUser to false"), Mr.updateIsNewUser());
        var o = U() || {}, s = o.query, a = o.scene, c = o.coldStart, u = o.referrerInfo, d = (s || {}).share_guid, l = e || {}, f = l.isColdStart, h = void 0 === f ? !!c : f, g = l.isNewUser, p = void 0 === g ? n : g, m = l.extend, v = Object.assign(s, {
            referrerInfo: u
        }), y = this._pkg({
            is_new_user: p ? 0 : 1,
            open_type: h ? 0 : 1,
    ...
    _getLoginData: function(e) {
        var t = (Mr.getSDKUserInfo() || {}).isNewUser, n = U() || {}, r = n.query, i = n.scene, o = (r || {}).shareConfigId, s = e || {}, a = s.isNewUser, c = void 0 === a ? t : a, u = s.extend, d = this._getBasicData({
            eventType: "track"
        });
...
}, yo = "scope.userInfo", wo = u("createUserInfoButton", "2.0.1"), Io = null, _o = function(e) {
    return new Promise(function(t, n) {
    ...
    return e.decode = function(e, t, n, r, i) {
        var o = t, s = this.transCode(o, n), a = this.getKey(s, r);
...
}(), To = "function" == typeof btoa, bo = "function" == typeof Buffer;

"function" == typeof TextDecoder && new TextDecoder();

var Co, xo = "function" == typeof TextEncoder ? new TextEncoder() : void 0, ko = Array.prototype.slice.call("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
...
}, Do = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, Mo = bo ? function(e) {
...
}, Lo = !1, Ro = !1, qo = null, Ho = null, Fo = null, jo = {
    roleId: ""
}, Vo = !1;
...
ge.prototype = {
    ...
    _setData: function(e) {
        var t = vo.getLogDataByTopic(this.topic, e), n = t.property, r = t.extra, i = this.data, o = i.property, s = i.extra;
...
var Jo, Qo = {}, Xo = "invalid ad id in gm-v2", Yo = {}, $o = {}, Zo = {
...
}, as = null, cs = 1, us = 2, ds = 3, ls = "", fs = 0;
...
var hs = {
    _renderQuery: function(e) {
        var t = e || {}, n = t.query, r = t.shareConfigId, i = t.activityId, o = t.shareGuid, s = yn.getTimeSec(), a = Mr.getSDKUserInfo() || {}, c = a.h_shareCode, u = void 0 === c ? "" : c, d = a.channel, l = void 0 === d ? "hortor_" : d, f = a.origChannel, h = void 0 === f ? "" : f, g = {
    ...
    renderShare: function(e, t) {
        var n = (e || {}).beforeShare, r = yn.isFun(n) ? n(t) : null, i = Object.assign({}, t || {}, e || {}, r || {});
...
}, gs = u("updateShareMenu", "1.2.0"), ps = u("updateShareMenu", "2.4.0"), ms = {
    set: function(e) {
        return t(this, void 0, void 0, function() {
            var t, r, i;
            return n(this, function(n) {
...
Xe.prototype = {
    init: function(e) {
        if (!this.inited) {
            this.inited = !0;
            var t = e || {}, n = t.forceResult, r = t.shareSuccessDiff, i = t.onShareCallbackTime, o = t.success, s = t.fail, a = t.complete;
    ...
    onShow: function(e, t) {
        if (!this.destroyed) {
            var n = e || {}, r = n.success, i = n.fail, o = n.complete, s = ((t || {}).data || {}).hideDuration;
...
Zt.once(Rt, function() {
    var e;
    b(Yt, Ye), e = D();
    var r = (ys = Object.assign({}, ys || vs, e || {})).openShareTimeline, o = void 0 !== r && r, s = u("onShareTimeline", "2.11.3") && o;
    Je(s ? {
        withShareTicket: !0,
    ...
    var a = ys || {}, c = a.openGetShareTheme, d = void 0 === c || c, l = a.shareThemes;
    d && function(e) {
        return t(this, void 0, void 0, function() {
            var t, r, i;
            return n(this, function(n) {
...
var Ts = u("requestSubscribeMessage", "2.8.3"), bs = u("requestSubscribeWhatsNew", "2.10.4"), Cs = {
    accept: "acceptIds",
    reject: "rejectIds",
    ban: "banIds"
}, xs = {
    ...
    var t = D() || {}, n = t.gameId, r = t.wallKey, i = t.gameVersion, o = t.key, s = Mr.getSDKUserInfo() || {}, a = s.userId, c = s.uniqueId, u = s.sex, d = s.channel, l = s.origChannel, f = s.masterUniqueId, h = Mr.getGameUser(), g = h.serverId, p = void 0 === g ? "" : g, m = h.roleId, v = U();
    v.scene;
    var y = v.custom || {}, w = y.channel, I = y.origChannel;
...
}, Us = "", Ds = As, Ms = function() {
    return Us;
}, Ns = function(e, t) {
    !function(e) {
        var t = D() || {}, n = t.wallKey, r = t.key;
        if (n || r) {
            var i = (U().custom || {}).boxCode, o = void 0 === i ? "" : i, s = As(Object.assign({
                traceId: "",
                wallCode: o
            }, e || {})), a = tn.combHost + "/wall/api/v1/log";
    ...
    _toTempFilePath: function(e, t) {
        return new Promise(function(n, r) {
            var i = t.x, o = void 0 === i ? 0 : i, s = t.y, a = void 0 === s ? 0 : s, c = t.w, u = t.h;
            e.toTempFilePath({
                x: o,
                y: a,
                width: c,
    ...
    _onLaunch: function() {
        var e = Mr.getSDKUserInfo() || {}, t = e.userId, n = e.uniqueId;
        if (t && n) return Ns(2);
        Zt.once(Vt, function() {
            Ns(2);
        });
    ...
    _bindEvent: function() {
        var e = this, t = null, n = (D() || {}).taskCheckDelay || 1500;
        Zt.on(qt, function(r) {
            var i = (r || {}).data;
    ...
    _fixOnlineLog: function(e) {
        var t = this.lastTask || {}, n = t.traceId, r = t.taskId, o = t.actionType;
...
var Fs, js = u("createFeedbackButton", "2.1.2"), Vs = u("getLogManager", "2.1.0");
...
}, Ws = !1, Ks = "", Bs = "scope.writePhotosAlbum", zs = "minigame", Js = [];
...
exports.VibrateType = ti, exports.WXMicroAppType = zr, exports.WXScene = Kr, exports._getWXCode = function() {
    ...
    return new Promise(function(e, t) {
        var n = D().combGameId, r = (Mr.getSDKUserInfo() || {}).uniqueId;
    ...
    return new Promise(function(e, t) {
        var n = (Mr.getSDKUserInfo() || {}).uniqueId, r = D().gameId;
    ...
    var e = (Mr.getSDKUserInfo() || {}).uniqueId, t = tn.combHost + "/customer/api/v1/gs/new/comb/info?gameId=" + Un.option.combGameId + "&gameTp=comb&uniqueId=" + e + "&system=" + (wn ? "ios" : "android");
    return new Promise(function(e, n) {
        bn.get(t).then(function(t) {
    ...
    return new Promise(function(t, n) {
        var r = (Mr.getSDKUserInfo() || {}).uniqueId, i = tn.combAPI + "questionnaires", o = {
        ...
        bn.get(i, o).then(function(e) {
            var r, i, o, s, a, c, u;
            if (console.warn("getQuestionnaire", e), 0 == (null === (r = null == e ? void 0 : e.meta) || void 0 === r ? void 0 : r.errCode) && (null === (i = null == e ? void 0 : e.data) || void 0 === i ? void 0 : i.questionnaires) && (null === (s = null === (o = null == e ? void 0 : e.data) || void 0 === o ? void 0 : o.questionnaires) || void 0 === s ? void 0 : s.length) > 0) t(e.data.questionnaires); else {
    ...
    return new Promise(function(e, t) {
        var n = tn.combAPI + "questionnaires/config", r = {
            gameId: Un.option.gameId || ""
        };
    ...
    return new Promise(function(t, n) {
        var r = Un.sdkConfig().gameId, i = Un.sdkConfig().combGameId, o = tn.combHost + "/customer/api/v1/gameConfig/sdk/config?gameId=" + r;
    ...
    return new Promise(function(t, n) {
        kt("click");
        var r = e.index, i = Js[r], o = i.appId, s = i.path, a = i.extraData, c = void 0 === a ? {} : a, u = i.envVersion;
    ...
    e = A(e, "receiveMsgFromMainModule"), Zt.on(Vt, function() {
        var t = D() || {}, n = t.gameId, r = t.env, i = Mr.getTempUser() || {}, o = Et({
            gameId: n,
            env: r
        }, i);
    ...
    var e = D() || {}, t = e.gameId, n = e.env, r = Mr.getTempUser() || {};
    return Et({
        gameId: t,
        env: n
    }, r);
    ...
    return new Promise(function(t, n) {
        var r = (Mr.getSDKUserInfo() || {}).uniqueId, i = tn.combAPI + "questionnaires/" + e.questionnaireId + "/answers", o = {
            roleId: e.roleId,
    ...
    if (void 0 === e && (e = {
        ...
        var t = Mr.combUserInfo, n = t.envCombSdkInfo, r = t.combSdkInfo, i = r.uniqueId;
        n && n.uniqueId && (i = n.uniqueId);
        var o = tn.combHost + "/customer/api/v1/gs/new/log", s = e.eventType, a = {
            gameId: Un.option.gameId,
            confTp: Gs.confTp,
            gameTp: "minigame",
            eventTp: {
