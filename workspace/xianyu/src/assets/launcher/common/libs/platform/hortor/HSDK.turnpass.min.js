!function(t) {
            ...
            return function(u) {
                return function(e) {
                    ...
                    for (;a && (a = 0, e[0] && (c = 0)), c; ) try {
                        if (r = 1, i && (o = 2 & e[0] ? i.return : e[0] ? i.throw || ((o = i.return) && o.call(i), 
                        0) : i.next) && !(o = o.call(i, e[1])).done) return o;
    ...
    function o() {
        return t(this, void 0, void 0, function() {
            ...
            return n(this, function(n) {
                switch (n.label) {
                  case 0:
                    return t = m.ins.init, e = t.gameId, r = t.uniqueId, o = w(), u = m.wx, a = u ? u.getSystemInfoSync().brand : "", 
                    c = {
                        gameId: e,
                        uniqueId: r,
                        timestamp: o,
    ...
    function a() {
        return t(this, void 0, void 0, function() {
            ...
            return n(this, function(n) {
                switch (n.label) {
                  case 0:
                    return t = m.ins.init, e = t.gameId, r = t.uniqueId, o = m.ins.apiData, a = o.token, 
                    c = o.globalOffset, u = w(), s = {
                        gameId: e,
                        uniqueId: r,
                        timestamp: u,
                        offset: c,
    ...
    function c(r) {
        return t(this, void 0, void 0, function() {
            ...
            return n(this, function(n) {
                switch (n.label) {
                  case 0:
                    return t = m.ins.init, o = t.gameId, a = t.uniqueId, c = m.ins.apiData, u = c.token, 
                    s = c.validateId, l = w(), f = function(t) {
                        var n = [], r = !(l % 2);
        ...
        return t(this, void 0, void 0, function() {
            ...
            return n(this, function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return t = n.sent(), m.syncApi({
                        token: t
                    }), [ 4, a() ];

                  case 2:
                    if (e = n.sent(), m.syncApi({
                        validateId: e.validateId
                    }), r = H("tip-layout", {
                        top: 20,
                        left: 20
                    }), z(r, B), M(r, cc.Layout.Type.HORIZONTAL, cc.Layout.ResizeMode.CONTAINER), L(r, 572, 80), 
                    r.setAnchorPoint(0, .5), i = H("tip-label"), D(i, e.detail, 28, 0, "000000"), z(i, r), 
                    e.subTp == v.ClickMore) for (c = H("tip-imgs-layout"), z(c, r), c.getPosition().equals, 
                    c.setPosition(c.getPosition().add(cc.v2(0, 12))), M(c, cc.Layout.Type.HORIZONTAL, cc.Layout.ResizeMode.CONTAINER, 10), 
                    u = function(t) {
                  ...
                  case 3:
                    return n.sent(), L(d, 572, 280), h = H("click-layer"), z(h, f), L(h, 286, 140), 
                    d.on(cc.Node.EventType.TOUCH_END, function(t) {
                        var n = t.getLocation(), e = d.convertToNodeSpaceAR(n), r = d.getContentSize(), i = d.getAnchorPoint(), o = cc.v2(e.x + i.x * r.width, r.height - e.y - (1 - i.y) * r.height), a = H("child"), c = q(a);
                        z(a, h), L(a, 60, 60), function(t, n, e) {
                            a.setPosition(cc.v2(n, e));
                        }(0, e.x, e.y), c.lineWidth = 10, c.circle(0, 0, 20), c.strokeColor = cc.Color.WHITE, 
                        c.stroke(), U(c, "2165fc");
    ...
    var m = function() {
        ...
        for (n = 0; n < t.length; n += 3) {
            ...
            e += I.charAt(r >> 2), e += I.charAt((3 & r) << 4 | i >> 4), e += n + 1 < t.length ? I.charAt((15 & i) << 2 | o >> 6) : "=", 
            e += n + 2 < t.length ? I.charAt(63 & o) : "=";
        }
        return e;
    }, T = function(t) {
        for (var n = t.indexOf("="), e = -1 !== n ? n : t.length, r = 3 * (t = t.replace(/=/g, "")).length / 4, i = new Uint8Array(r), o = 0, a = 0; a < e; a += 4) {
            var c = I.indexOf(t.charAt(a)), u = I.indexOf(t.charAt(a + 1)), s = I.indexOf(t.charAt(a + 2)), l = I.indexOf(t.charAt(a + 3)), f = c << 2 | u >> 4;
            if (i[o++] = f, -1 !== s) {
                var d = (15 & u) << 4 | s >> 2;
                i[o++] = d;
            }
    ...
    r.prototype.decode = function(t) {
        for (var n = "", e = 0; e < t.length; ) {
            var r = t[e], i = 0, o = 0;
            if (r <= 127 ? (i = 0, o = 255 & r) : r <= 223 ? (i = 1, o = 31 & r) : r <= 239 ? (i = 2, 
            o = 15 & r) : r <= 244 && (i = 3, o = 7 & r), t.length - e - i > 0) for (var a = 0; a < i; ) o = o << 6 | 63 & (r = t[e + a + 1]), 
            a += 1; else o = 65533, i = t.length - e;
            n += String.fromCodePoint(o), e += i + 1;
        }
        return n;
    };
    var S, k = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, P = (function(t) {
        !function(n) {
            function e(t, n) {
            ...
            function u(t, n) {
                ...
                d = e(d, u), h = e(h, s), g = e(g, l), p = e(p, f);
                return [ d, h, g, p ];
            }
            function s(t) {
            ...
            function g(t, n) {
                return function(t, n) {
                    var e, r, i = l(t), o = [], a = [];
                    for (o[15] = a[15] = void 0, 16 < i.length && (i = u(i, 8 * t.length)), e = 0; e < 16; e += 1) o[e] = 909522486 ^ i[e], 
                    a[e] = 1549556828 ^ i[e];
        ...
        return n && function(t, n) {
            ...
            null != n.top && (e.top = n.top, e.isAlignTop = !0), null != n.bottom && (e.bottom = n.bottom, 
            e.isAlignBottom = !0), null != n.right && (e.right = n.right, e.isAlignRight = !0), 
            null != n.left && (e.left = n.left, e.isAlignLeft = !0), n.isHorizontal && (e.isAlignHorizontalCenter = !0), 
        ...
        return new Promise(function(r, i) {
            R(n).then(function(n) {
                ...
                e ? function(t, n, e) {
                    t.spriteFrame = n, t.sizeMode = cc.Sprite.SizeMode.CUSTOM, t.type = cc.Sprite.Type.SLICED, 
    ...
    }, j = !1, J = null, V = null, B = null, X = null, K = [], W = [], G = {
        suc: null,
        err: null
    }, Z = null, Y = function(t, n) {
        void 0 === n && (n = "");
        var e = m.wx;
        t ? (e && e.showLoading({
            title: n,
            mask: !0
        }), V.enabled = !0) : (e && e.hideLoading(), V.enabled = !1);
    };
    console.warn("build time:", "4/8/2024, 7:57:13 PM"), console.warn("build vers:", "1.0.0"), 
            ...
            return new Promise(function(i, o) {
                return t(r, void 0, void 0, function() {
                    ...
                    return n(this, function(n) {
                        switch (n.label) {
                          case 0:
                            return n.trys.push([ 0, 2, , 3 ]), j ? [ 2, o({
                                errMsg: "请不要重复验证"
                            }) ] : (y({
                                event_step: "verify_start"
                            }), m.syncApi({
                                globalOffset: b(0, 5)
                            }), d(!0), J = e.node, Z = e.listener, function() {
                                ...
                                var f, d, h = H("confirm-label", {
                                    isHorizontal: !0,
                                    isVertical: !0
                                });
                                D(h, "确认", 26, 21), z(h, c), o.on(cc.Node.EventType.TOUCH_END, l), c.on(cc.Node.EventType.TOUCH_END, s), 
                                f = t, void 0 === d && (d = .5), new Promise(function(t) {
                                    cc.tween(f).set({
                                        opacity: 0,
                                        scale: .5
                                    }).to(d, {
